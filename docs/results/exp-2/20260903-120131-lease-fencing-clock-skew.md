...
| Starting SHA | `bebde9088590` (作業ツリーに未コミットの変更あり) |
...
| Environment | go1.24.7 linux/amd64 cpu=4 gomaxprocs=4 mysql=8.0.46-0ubuntu0.24.04.4 sha=bebde9088590+dirty |
| Started / Ended | 2026-09-03T12:01:31Z / 2026-09-03T12:01:42Z |
...
- 担当: A(fence=1) → B(fence=2)
- 最後に書いたのは B（fence=2）
- A の終了: exit=3 duration=103ms / B の終了: exit=0 duration=218ms
...
- A の終了: exit=0 duration=801ms / B の終了: exit=4 duration=1.03s
...
- 担当を取れたのは [W0 W1 W3 W5 W4 W2 W7 W6]
