...
| Started / Ended | 2026-09-03T12:12:09Z / 2026-09-03T12:12:11Z |
...
- fetching       exit=0 commit=2 ack=2 戻した=2 消失=0 goroutine=2(起動時 2)
- decoding       exit=0 commit=1 ack=1 戻した=3 消失=0 goroutine=2(起動時 2)
