...
| Starting SHA | `a9603a9d936a` (作業ツリーに未コミットの変更あり) |
...
| Environment | go1.24.7 linux/amd64 cpu=4 gomaxprocs=4 mysql=8.0.46-0ubuntu0.24.04.4 sha=a9603a9d936a+dirty |
| Started / Ended | 2026-09-03T11:55:29Z / 2026-09-03T11:55:43Z |
...
遅延: n=7 p50=13.397ms p95=20.884ms p99=20.884ms max=20.884ms
...
遅延: n=7 p50=18.772ms p95=24.698ms p99=24.698ms max=24.698ms
...
遅延: n=7 p50=25.737ms p95=41.733ms p99=41.733ms max=41.733ms
...
遅延: n=7 p50=22.15ms p95=33.979ms p99=33.979ms max=33.979ms
